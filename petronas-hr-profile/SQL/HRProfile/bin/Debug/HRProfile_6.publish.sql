...
GO
PRINT N'Creating Table [Master].[Competency]...';
...
CREATE TABLE [Master].[Competency] (
    ...
    CONSTRAINT [PK_Competency_CompetencyID] PRIMARY KEY CLUSTERED ([CompetencyID] ASC)
);


GO
PRINT N'Creating Default Constraint [Master].[DC_Competency_ActiveFlag]...';


GO
ALTER TABLE [Master].[Competency]
    ADD CONSTRAINT [DC_Competency_ActiveFlag] DEFAULT (1) FOR [ActiveFlag];


GO
PRINT N'Creating Default Constraint [Master].[DC_Competency_ModifiedTimeStamp]...';


GO
ALTER TABLE [Master].[Competency]
    ADD CONSTRAINT [DC_Competency_ModifiedTimeStamp] DEFAULT (GETUTCDATE()) FOR [ModifiedTimestamp];
